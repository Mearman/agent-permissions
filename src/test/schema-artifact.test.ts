...
const artifact = path.resolve(import.meta.dirname, '../../agent-permissions.schema.json');
...
function generateExpected(): unknown {
  ...
  const REPO_RAW_BASE = 'https://raw.githubusercontent.com/Mearman/agent-permissions/main';
  return {
